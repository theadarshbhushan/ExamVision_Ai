...
def main():
    ...
    input_dir = os.path.abspath(os.path.join(base_dir, "data", "test_footage", "cctv_real"))
    pipeline_script = os.path.abspath(os.path.join(os.path.dirname(__file__), "test_full_pipeline.py"))
