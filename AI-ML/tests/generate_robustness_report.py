...
def run_test_on_video(video_path, category_name):
    ...
    video_snapshots_dir = os.path.join(BASE_DIR, "data", "snapshots", video_name)
...
def main():
    ...
    videos_to_test = [
        ...
        (os.path.join(BASE_DIR, "data", "self_recorded", "clip_20260808_230638.mp4"), "Poor Lighting (Webcam)"),
        # Webcam phone detection
        (os.path.join(BASE_DIR, "data", "self_recorded", "clip_20260810_143447.mp4"), "Webcam Phone Detection (Baseline)"),
        # CCTV confirmed working
        (os.path.join(BASE_DIR, "data", "test_footage", "cctv_real", "cctv_01_phone.mkv"), "CCTV Phone Detection (Baseline)"),
        # CCTV camera vibration
        (os.path.join(BASE_DIR, "data", "test_footage", "cctv_real", "cctv_06_chit.mkv"), "Camera Shake (Vibration)"),
        # CCTV talking (innocent activity)
        (os.path.join(BASE_DIR, "data", "test_footage", "cctv_real", "cctv_04_talking.mkv"), "Innocent Student Talking"),
        # CCTV crowded / busy setting
        (os.path.join(BASE_DIR, "data", "test_footage", "cctv_real", "cctv_05_crowd.mp4"), "Busy Hall / Crowded Scenario"),
    ]
    ...
    report_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "docs", "robustness_report.md"))
