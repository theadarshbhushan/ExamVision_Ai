...
ZIP_PATH = os.path.join(BASE_DIR, "data", "archive", "zips", "cheating dataset.v1i.yolov8.zip")
DST_DATASET_DIR = os.path.join(BASE_DIR, "data", "datasets", "phone_chit_detection", "cheating_dataset")
REFINED_DIR = os.path.join(BASE_DIR, "data", "datasets", "phone_chit_detection", "new_labeled_refined")
CCTV_V2_DIR = os.path.join(BASE_DIR, "data", "datasets", "phone_chit_detection", "cctv_labeled_v2")
